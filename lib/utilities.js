var utilities = (function(){
	...
	*/
	...
	utilities.prototype.parseValue = function(type, value){
		if(value === ''){
			return value;
		}
		...
		switch(type){
			...
			case 'datetime':
				...
				return that.parseValue('date', value) + ' ' + that.leadingZero(d.getHours(), 10) + ':' + that.leadingZero(d.getMinutes(), 10);
			case 'timeofday':
				var hours = 0,
					minutes = 0,
					seconds = 0,
					temp = parseInt(value) / 1000;
				...
				return that.leadingZero(hours, 10) + ':' + that.leadingZero(minutes, 10); // + ':' + leadingZero(seconds, 10);
		}

		return value;
	};

	utilities.prototype.leadingZero = function(i, n){
		i = '' + i;
		n = '' + n;
	...
	utilities.prototype.trailingZero = function(i, n){
		i = '' + i;
		n = '' + n;
