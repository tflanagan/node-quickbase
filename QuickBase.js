var https = require('https'),
	...
	quickbase = (function(){
		...
		quickbase.prototype._assemblePayload = function(query){
		...
		quickbase.prototype._pollForQueue = function(){
			if(this.connected){
		...
		quickbase.prototype._prepareOption = function(option, value){
			if(option.match(/^_/)){
				return value;
			}
		...
		quickbase.prototype._preparePayload = function(query){
			var payload = '',
		...
		quickbase.prototype._reconstructXMLResult = function(result){
		...
		quickbase.prototype._transmit = function(query, cb){
			var that = this;
		...
		quickbase.prototype._return = function(query, code, text, details, results){
			var status = {
		...
		quickbase.prototype.api = function(action, options, callback){
		...
		quickbase.prototype.api.prototype.API_Authenticate = function(query){
			var that = this;
		...
		quickbase.prototype.api.prototype.API_DoQuery = function(query){
			var that = this;
		...
		quickbase.prototype.api.prototype.API_AddRecord = function(query){
		...
		quickbase.prototype.api.prototype.API_EditRecord = function(query){
			this.queries[query].options.field = [];
		...
		quickbase.prototype._prepareOption.prototype._joinIfArray = function(value, del){
		...
		quickbase.prototype._prepareOption.prototype.clist = function(value){
			return this._joinIfArray(value, '.');
		};

		quickbase.prototype._prepareOption.prototype.clist_output = function(value){
			return this._joinIfArray(value, '.');
		};
		...
		quickbase.prototype._prepareOption.prototype.options = function(value){
			return this._joinIfArray(value, '.');
		};

		quickbase.prototype._prepareOption.prototype.field = function(value){
